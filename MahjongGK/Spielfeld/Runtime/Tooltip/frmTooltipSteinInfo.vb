...
Public NotInheritable Class frmTooltipSteinInfo
    ...
    ''' </summary>
    Private Shared Function GetSteinText(value As SteinIndexEnum) As String

        Select Case value
            Case SteinIndexEnum.ErrorSy : Return "Error"
            Case SteinIndexEnum.Punkt01 : Return "Punkt 01"
            Case SteinIndexEnum.Punkt02 : Return "Punkt 02"
            Case SteinIndexEnum.Punkt03 : Return "Punkt 03"
            Case SteinIndexEnum.Punkt04 : Return "Punkt 04"
            Case SteinIndexEnum.Punkt05 : Return "Punkt 05"
            Case SteinIndexEnum.Punkt06 : Return "Punkt 06"
            Case SteinIndexEnum.Punkt07 : Return "Punkt 07"
            Case SteinIndexEnum.Punkt08 : Return "Punkt 08"
            Case SteinIndexEnum.Punkt09 : Return "Punkt 09"

            Case SteinIndexEnum.Bambus1 : Return "Bambus 1"
            Case SteinIndexEnum.Bambus2 : Return "Bambus 2"
            Case SteinIndexEnum.Bambus3 : Return "Bambus 3"
            Case SteinIndexEnum.Bambus4 : Return "Bambus 4"
            Case SteinIndexEnum.Bambus5 : Return "Bambus 5"
            Case SteinIndexEnum.Bambus6 : Return "Bambus 6"
            Case SteinIndexEnum.Bambus7 : Return "Bambus 7"
            Case SteinIndexEnum.Bambus8 : Return "Bambus 8"
            Case SteinIndexEnum.Bambus9 : Return "Bambus 9"

            Case SteinIndexEnum.Symbol1 : Return "Symbol 1"
            Case SteinIndexEnum.Symbol2 : Return "Symbol 2"
            Case SteinIndexEnum.Symbol3 : Return "Symbol 3"
            Case SteinIndexEnum.Symbol4 : Return "Symbol 4"
            Case SteinIndexEnum.Symbol5 : Return "Symbol 5"
            Case SteinIndexEnum.Symbol6 : Return "Symbol 6"
            Case SteinIndexEnum.Symbol7 : Return "Symbol 7"
            Case SteinIndexEnum.Symbol8 : Return "Symbol 8"
            Case SteinIndexEnum.Symbol9 : Return "Symbol 9"

            Case SteinIndexEnum.DracheR : Return "roter Drache"
            Case SteinIndexEnum.DracheG : Return "grüner Drache"
            Case SteinIndexEnum.DracheW : Return "weißer Drache"

            Case SteinIndexEnum.WindOst : Return "Ostwind"
            Case SteinIndexEnum.WindSüd : Return "Südwind"
            Case SteinIndexEnum.WindWst : Return "Westwind"
            Case SteinIndexEnum.WindNrd : Return "Nordwind"

            Case SteinIndexEnum.BlütePf : Return "Pfaume"
            Case SteinIndexEnum.BlüteOr : Return "Orchidee"
            Case SteinIndexEnum.BlüteCt : Return "Chrysantheme"
            Case SteinIndexEnum.BlüteBa : Return "Bambus"

            Case SteinIndexEnum.JahrFrl : Return "Frühling"
            Case SteinIndexEnum.JahrSom : Return "Sommer"
            Case SteinIndexEnum.JahrHer : Return "Herbst"
            Case SteinIndexEnum.JahrWin : Return "Winter"
