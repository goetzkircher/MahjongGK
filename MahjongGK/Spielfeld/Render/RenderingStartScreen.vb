...
Namespace Spielfeld
    ...
    Public Module RenderingStartScreen
        ...
        Public Sub PaintStartScreen(gfxStartcreeen As Graphics, rectOutput As Rectangle)
            ...
            If Not IsNothing(StartscreenBackgroundImage) AndAlso StartscreenBackgroundImage.Size = rectOutput.Size Then
                gfxStartcreeen.DrawImageUnscaledAndClipped(StartscreenBackgroundImage, rectOutput)
                Exit Sub
            End If

            StartscreenBackgroundImage = New Bitmap(rectOutput.Width, rectOutput.Height, PixelFormat.Format32bppArgb)
            Dim gfx As Graphics = Graphics.FromImage(StartscreenBackgroundImage)

            ' 1) Hintergrund
            If StartscreenBackgroundImageCache.HasBitmap Then
                gfx.DrawImageUnscaledAndClipped(StartscreenBackgroundImageCache.GetBitmap(rectOutput.Size), rectOutput)
            Else
        ...
        Private Function GetBackgroundPreviewColor() As Color
            If Not StartscreenBackgroundImageCache.HasBitmap Then
