...
''' <summary>
''' Pfad: MahjongGK/Spielfeld/Container/RectangleX
''' 
...
#Region "Wie Rectangle – Properties & Konvertierung"
    ...
    Public Function EqualsRect(rect As RectangleX) As Boolean
        With rect
            If rect Is Nothing Then
                Return False
            End If
            Return _x = .X AndAlso _y = .Y AndAlso _w = .Width AndAlso _h = .Height
        End With
    End Function

    Public Function EqualsRect(rect As Rectangle) As Boolean
        With rect
            Return _x = .X AndAlso _y = .Y AndAlso _w = .Width AndAlso _h = .Height
        End With
    End Function
