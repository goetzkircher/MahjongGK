...
Public Module HScrollRenderer
    ...
    Public Sub SetValue(v As Integer)
        CoerceValue(v, setFlag:=True)
    End Sub

    Public Sub ScrollBy(delta As Integer)
        CoerceValue(_value + delta, setFlag:=True)
    End Sub

    Public Sub ScrollPageLeft()
        CoerceValue(_value - _largeChange, setFlag:=True)
    End Sub
    ...
    Public Function HandleMouseMove(x As Integer, y As Integer, hostRect As Rectangle) As Boolean
        ...
        CoerceValue(newVal, setFlag:=True)
    ...
    Public Function HandleMouseWheel(delta As Integer) As Boolean
        ...
        Dim before As Integer = _value
        CoerceValue(_value + dir * steps * _smallChange, setFlag:=True)
    ...
    ' ── interne Helfer ───────────────────────────────────────────────────────
    Private Sub CoerceValue(v As Integer, Optional setFlag As Boolean = False)
