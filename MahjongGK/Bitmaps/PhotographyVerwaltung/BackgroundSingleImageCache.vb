...
#Region "Öffentliche API"
        ...
        Private _backgroundDominantColor As Color = Color.Black
        Public ReadOnly Property BackgroundDominantColor As Color
            Get
                Return _backgroundDominantColor
            End Get
        End Property
        ...
        Public Function GetBitmap(targetSize As Size, Optional backgroundColor As Color? = Nothing) As Bitmap
           ...
           ((_mode <> BackgroundImageRenderMode.FitInside) OrElse _lastBg.ToArgb() = _backgroundDominantColor.ToArgb()) Then
                Return _lastBitmap
            End If

            Rebuild_NoLock(targetSize, _mode, _backgroundDominantColor)
            Return _lastBitmap
        End Function
