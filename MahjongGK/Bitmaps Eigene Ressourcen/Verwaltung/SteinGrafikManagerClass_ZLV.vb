...
'    Public Class SteinGrafikManagerClass_ZLV
...
'        Private _currentSatz As SteinSatzOld = SteinSatzOld.None
...
'        ''' <summary>
'        ''' Lädt/wechsel den SteinSatzOld. Liest XML ein und leert sämtliche Caches.
'        ''' Optional: Basis-Bitmaps (Referenzgröße) sofort dekodieren (kein Vorrats-Scaling!).
'        ''' satz = SteinSatzOld.None löscht alles und gibt True zurück.
'        ''' </summary>
'        Public Function PreloadSteinSatz(satz As SteinSatzOld, Optional decodeAllBasePNGs As Boolean = True) As Boolean
...
'        Public ReadOnly Property GetCurrentSteinsatz As SteinSatzOld
'            Get
'                Return _currentSatz
'            End Get
'        End Property
