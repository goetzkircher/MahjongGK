Public Module GlobalConstants
    ...
    'Public Const MJ_GRAFIK_STEIN_BASIS_WIDTH As Integer = 200
    'Public Const MJ_GRAFIK_STEIN_BASIS_WIDTH_DBL As Double = 200

    'Public Const MJ_GRAFIK_STEIN_BASIS_HEIGHT As Integer = 242
    'Public Const MJ_GRAFIK_STEIN_BASIS_HEIGHT_DBL As Double = 242
